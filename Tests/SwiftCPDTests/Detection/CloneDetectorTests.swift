...
struct CloneDetectorTests {
    ...
    func noFalsePositivesForRealWorldDesignTokens() {
        let fileA = makeFileTokens(source: designTokensColorsSource, file: "DSColors.swift")
        let fileB = makeFileTokens(source: designTokensGridsSource, file: "DSGrids.swift")
...
private let designTokensColorsSource = """
    public enum DSColors {
        public enum Black {
            public static let solid = Color(r: 0, g: 0, b: 0)
            public static let opacity10 = Color(r: 0, g: 0, b: 0, a: 0.1)
...
private let designTokensGridsSource = """
    public enum DSGrids {
        public enum Desktop {
