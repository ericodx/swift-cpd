...
extension CloneDetector {
    ...
    private func deduplicateClones(_ pairs: [ClassifiedClonePair], files: [FileTokens]) -> [CloneGroup] {
        var uniquePairs: [ClassifiedClonePair] = []
...
extension CloneDetector {
    ...
    private func isSubsumed(_ pair: ClassifiedClonePair, by other: ClassifiedClonePair) -> Bool {
    ...
    private func buildCloneGroup(from pair: ClassifiedClonePair, files: [FileTokens]) -> CloneGroup {
        let fragmentA = CloneFragment(
