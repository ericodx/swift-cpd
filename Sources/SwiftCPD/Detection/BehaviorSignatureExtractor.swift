...
final class BehaviorSignatureExtractor: RangedSyntaxVisitor {
    ...
    private var controlFlowNodes: [ControlFlowNode] = []
    private var calledFunctions: Set<String> = []
    private var definedVariables: Set<String> = []
    private var usedVariables: Set<String> = []
    private var parameterNames: Set<String> = []
    private var typeAnnotations: Set<String> = []
